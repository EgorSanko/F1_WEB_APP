...
ACHIEVEMENTS = {
    ...
    "perfect_podium":      {"name": "Знаток подиума",      "desc": "Угадай 2+ из 3 подиума",             "icon": "🥇"},
    "streak_3":            {"name": "Дубль",               "desc": "2 верных прогноза подряд",           "icon": "🔥"},
    "streak_5":            {"name": "Хет-трик",            "desc": "3 верных прогноза подряд",           "icon": "⚡"},
    "streak_10":           {"name": "На серии!",           "desc": "4 верных прогноза подряд",           "icon": "👑"},
    "points_500":          {"name": "Полтысячи",           "desc": "Набери 500 очков",                   "icon": "💰"},
    "points_1000":         {"name": "Магнат",              "desc": "Набери 750 очков",                   "icon": "💎"},
